...
// active detections, and node telemetry strip. render() is reconcile-based: it never tears down a
// live <video>, so it is safe to call on every SSE/MQTT tick.
...
export function render(container, ctx){
  ...
  // --- active detections (rebuilt each render; no live video here) ---
  threats.innerHTML = '';
